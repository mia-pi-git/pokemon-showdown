...
export const commands: ChatCommands = {
	...
	roomownerhelp: [`/roomowner [username] - Appoints [username] as a room owner.`],
	...
	roompromotehelp: [
		`/roompromote OR /roomdemote [username], [group symbol] - Promotes/demotes the user to the specified room rank.`,
		`/room[group] [username] - Promotes/demotes the user to the specified room rank.`,
		`/roomdeauth [username] - Removes all room rank from the user.`,
	],
	...
	redirhelp: [
		...
		`Attempts to redirect the [username] to the [roomname].`,
	],
	...
	hourmutehelp: [`/hourmute OR /hm [username], [reason] - Mutes a user with reason for an hour.`],
	...
	unmutehelp: [`/unmute [username] - Removes mute from user.`],
	...
	banhelp: [`/ban [username], [reason] - Bans the user from the room you are in.`],
	...
	unbanhelp: [`/unban [username] - Unbans the user from the room you are in.`],
	...
	lockhelp: [
		`/lock OR /l [username], [reason] - Locks the user from talking in all chats.`,
	...
	unlockiphelp: [`/unlockip [ip] - Unlocks a punished ip while leaving the original punishment intact.`],
	unlocknamehelp: [`/unlockname [name] - Unlocks a punished alt, leaving the original lock intact.`],
	unlockhelp: [
		`/unlock [username] - Unlocks the user.`,
		`/unlockname [username] - Unlocks a punished alt while leaving the original punishment intact.`,
		`/unlockip [ip] - Unlocks a punished ip while leaving the original punishment intact.`,
	],
	...
	globalbanhelp: [
		`/globalban OR /gban [username], [reason] - Kick user from all rooms and ban user's IP address with reason.`,
	...
	unglobalbanhelp: [`/unglobalban [username] - Unban a user.`],
	...
	unbanallhelp: [`/unbanall - Unban all IP addresses.`],
	...
	deroomvoiceallhelp: [`/deroomvoiceall - Devoice all roomvoiced users.`],
	...
	baniphelp: [
		...
		`Existing users on the IP will not be banned.`,
	],
	...
	unbaniphelp: [`/unbanip [ip] - Unbans. Accepts wildcards to ban ranges.`],
	...
	modnotehelp: [`/modnote [note] - Adds a moderator note that can be read through modlog.`],
	...
	promotehelp: [`/promote [username], [group] - Promotes the user to the specified group.`],
	...
	trustuserhelp: [
		`/trustuser [username] - Trusts the user (makes them immune to locks).`,
		`/untrustuser [username] - Removes the trusted user status from the user.`,
	],
	...
	demotehelp: [`/demote [username], [group] - Demotes the user to the specified group.`],
	...
	declarehelp: [`/declare [message] - Anonymously announces a message.`],
	...
	htmldeclarehelp: [`/htmldeclare [message] - Anonymously announces a message using safe HTML.`],
	...
	globaldeclarehelp: [`/globaldeclare [message] - Anonymously announces a message to all rooms on the site.`],
	...
	chatdeclarehelp: [`/cdeclare [message] - Anonymously announces a message to all chatrooms on the server.`],
	...
	announcehelp: [`/announce OR /wall [message] - Makes an announcement.`],
	...
	notifyrankhelp: [
		`/notifyrank [rank], [title], [message], [highlight] - Sends a notification to users who are [rank] or higher (and highlight on [highlight], if specified).`,
		`/notifyoffrank [rank] - Closes the notification previously sent with /notifyrank [rank].`,
	],
	...
	forcerenamehelp: [
		`/forcerename OR /fr [username], [reason] - Forcibly change a user's name and shows them the [reason].`,
	...
	namelockhelp: [`/namelock OR /nl [user], [reason] - Name locks a [user] and shows the [reason].`],
	...
	unnamelockhelp: [`/unnamelock [username] - Unnamelocks the user.`],
	...
	hidetexthelp: [
		`/hidetext [username], [optional reason] - Removes a user's messages from chat, with an optional reason.`,
		`/hidealtstext [username], [optional reason] - Removes a user's messages and their alternate accounts' messages from the chat, with an optional reason. `,
		`/hidelines [username], [number], [optional reason] - Removes the [number] most recent messages from a user, with an optional reason.`,
	],
	...
	blacklisthelp: [
		`/blacklist [username], [reason] - Blacklists the user from the room you are in for a year.`,
		`/unblacklist [username] - Unblacklists the user from the room you are in.`,
		`/showblacklist OR /showbl - show a list of blacklisted users in the room.`,
		`/expiringblacklists OR /expiringbls - show a list of blacklisted users from the room whose blacklists are expiring in 3 months or less.`,
	],
	...
	battlebanhelp: [
		...
		`Prevents the user from starting new battles for 2 days and shows them the [reason].`,
	],
	...
	unbattlebanhelp: [`/unbattleban [username] - [DEPRECATED] Allows a user to battle again.`],
	...
	blacklistnamehelp: [
		`/blacklistname OR /nameblacklist [name1, name2, etc.] | reason - Blacklists all name(s) from the room you are in for a year.`,
	],
	...
	unblacklisthelp: [`/unblacklist [username] - Unblacklists the user from the room you are in.`],
