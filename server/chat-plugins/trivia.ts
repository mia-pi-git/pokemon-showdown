...
const commands: ChatCommands = {
	...
	newhelp: [`/trivia new [mode], [category], [length] - Begin a new trivia game.`],
	...
	kickhelp: [`/trivia kick [username] - Kick players from a trivia game by username.`],
	...
	starthelp: [`/trivia start - Ends the signup phase of a trivia game and begins the game.`],
	...
	endhelp: [`/trivia end - Forcibly end a trivia game.`],
	...
	submithelp: [`/trivia submit [category] | [question] | [answer1], [answer2] ... [answern] - Adds question(s) to the submission database for staff to review.`],
	addhelp: [`/trivia add [category] | [question] | [answer1], [answer2], ... [answern] - Adds question(s) to the question database.`],
	...
	reviewhelp: [`/trivia review - View the list of submitted questions.`],
	...
	accepthelp: [`/trivia accept [index1], [index2], ... [indexn] OR all - Add questions from the submission database to the question database using their index numbers or ranges of them.`],
	rejecthelp: [`/trivia reject [index1], [index2], ... [indexn] OR all - Remove questions from the submission database using their index numbers or ranges of them.`],
	...
	deletehelp: [`/trivia delete [question] - Delete a question from the trivia database.`],
	...
	movehelp: [
		`/trivia move [category] | [question] - Change the category of question in the trivia databse.`,
	],
	...
	searchhelp: [`/trivia search [type], [query] - Searches for questions based on their type and their query. Valid types: submissions, subs, questions, qs.`],
	...
	clearqshelp: [`/trivia clears [category] - Remove all questions of the given category.`],
	...
	triviahelp() {
		this.sendReply('|html|<div class="infobox infobox-limited">' + [
			...
			Utils.html`- <code>/trivia new [mode], [category], [length]</code> - Begin signups for a new trivia game.`,
			`- <code>/trivia join</code> - Join a trivia game during signups.`,
			Utils.html`- <code>/trivia start</code> - Begin the game once enough users have signed up.`,
			`- <code>/ta [answer]</code> - Answer the current question.`,
			Utils.html`- <code>/trivia kick [username]</code> - Disqualify a participant from the current trivia game.`,
			`- <code>/trivia leave</code> - Makes the player leave the game.`,
			Utils.html`- <code>/trivia end</code> - End a trivia game.`,
			``,
			`<strong>Question-modifying commands:</strong>`,
			Utils.html`- <code>/trivia submit [category] | [question] | [answer1], [answer2] ... [answern]</code> - Adds question(s) to the submission database for staff to review.`,
			Utils.html`- <code>/trivia review</code> - View the list of submitted questions.`,
			Utils.html`- <code>/trivia accept [index1], [index2], ... [indexn] OR all</code> - Add questions from the submission database to the question database using their index numbers or ranges of them.`,
			Utils.html`- <code>/trivia reject [index1], [index2], ... [indexn] OR all</code> - Remove questions from the submission database using their index numbers or ranges of them.`,
			Utils.html`- <code>/trivia add [category] | [question] | [answer1], [answer2], ... [answern]</code> - Adds question(s) to the question database.`,
			Utils.html`- <code>/trivia delete [question]</code> - Delete a question from the trivia database.`,
			`- <code>/trivia qs</code> - View the distribution of questions in the question database.`,
			Utils.html`- <code>/trivia qs [category]</code> - View the questions in the specified category.`,
			Utils.html`- <code>/trivia clearqs [category]</code> - Clear all questions in the given category.`,
			``,
			`<strong>Informational commands:</strong>`,
			Utils.html`- <code>/trivia search [type], [query]</code> - Searches for questions based on their type and their query. Valid types: <code>submissions</code>, <code>subs</code>, <code>questions</code>, <code>qs</code>.`,
