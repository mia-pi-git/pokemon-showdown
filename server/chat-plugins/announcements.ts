...
export const commands: ChatCommands = {
	announcement: {
		...
		newhelp: [`/announcement create [announcement] - Creates an announcement.`],
		...
		timerhelp: [
			`/announcement timer [minutes] - Sets the announcement to automatically end after [minutes] minutes.`,
			`/announcement timer clear - Clears the announcement's timer.`,
		],
		...
		endhelp: [`/announcement end - Ends a announcement and displays the results.`],
	...
	announcementhelp: [
		...
		`/announcement create [announcement] - Creates a announcement.`,
		`/announcement htmlcreate [announcement] - Creates a announcement, with HTML allowed.`,
		`/announcement timer [minutes] - Sets the announcement to automatically end after [minutes].`,
		`/announcement display - Displays the announcement`,
		`/announcement end - Ends a announcement.`,
	],
};
