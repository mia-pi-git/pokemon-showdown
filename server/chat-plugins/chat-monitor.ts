...
export const commands: ChatCommands = {
	...
	filterhelp: [
		`- /filter add list, word, reason - Adds a word to the given filter list.`,
		`- /filter remove list, words - Removes words from the given filter list.`,
		`- /filter view - Opens the list of filtered words.`,
	],
