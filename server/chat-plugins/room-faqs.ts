...
export const commands: ChatCommands = {
	...
	roomfaqhelp: [
		...
		`/addfaq <topic>, <text> - Adds an entry for <topic> in this room or updates it.`,
		`/addalias <alias>, <topic> - Adds <alias> as an alias for <topic>, displaying it when users use /roomfaq <alias>.`,
		`/removefaq <topic> - Removes the entry for <topic> in this room. If used on an alias, removes the alias.`,
	],
};
